#SOURCE CODE FOR GRAPH: AIR MASS VS. TOTAL FLUX:
import numpy as np
import matplotlib.pyplot as plt
# Load the data from the first text file
data1 = np.loadtxt('C:\\Users\\27672\\Documents\\BLUE FILTER.txt', delimiter=',')
# Load the data from the second text file
data2 = np.loadtxt('C:\\Users\\27672\\Documents\\INDIGO FILTER.txt', delimiter=',')
# Load the data from the third text file
data3 = np.loadtxt('C:\\Users\\27672\\Documents\\VIOLET FILTER.txt', delimiter=',')
...
x3 = data3[:, 0]
y3 = data3[:, 2]
y3 = np.sort(y3)[::-1] # Sort and reverse the y values
...
plt.title("Airmass Vs. Total Flux")
plt.xlabel("Airmass")
plt.ylabel("Total Flux (10^6)")
plt.legend()
plt.grid(True)
